  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta-acordeon-verde").mt-5
      .row(titulo="Tasa de interés")
        .col-12.mb-md-0.p-5
          p Modalidad en el cobro de los intereses: Se cobran por período anticipado, es decir, intereses que se descuentan al inicio de cada período y otros por período vencido, que son los que se cobran al final de cada periodo. 
      ...
      div(titulo="Tasa de interés periódico")
        .col-12.mb-md-0.p-5
          ...
          .row.justify-content-center
           .col-sm-6
              figure
                img(src='@/assets/curso/temas/tema1/formula4.png', alt='')
      ...
      div(titulo="Tasa de interés nominal")
        .col-12.mb-md-0.p-5
          ...
          .row.justify-content-center
           .col-sm-6
              figure
                img(src='@/assets/curso/temas/tema1/formula6.png', alt='')
