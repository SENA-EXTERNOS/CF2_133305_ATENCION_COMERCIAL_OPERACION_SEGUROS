  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-around.align-items-center.mt-5.mb-5
      .col-lg-4.mb-5.mb-lg-0
        figure
          img(src="@/assets/curso/temas/introduccion/introduccion.png", alt="alt")
    ...
    figure
     .video
       iframe(width="560" height="315" src="https://www.youtube.com/embed/XP433uL4Sc8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
